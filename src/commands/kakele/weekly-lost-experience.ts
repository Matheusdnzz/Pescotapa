...
export async function createDailyLostRankingImage(
  ...
  const backgroundImagePath =
    server === "global"
      ? "./src/assets/lost-experience/00.png"
      : "./src/assets/lost-experience/11.png";
  ...
  ctx.fillText(
    client.i18n.__({ phrase: "DAILY_LOST_EXPERIENCE_TITLE", locale: language }),
    30,
    105,
  );
...
export default new InteractionCommand({
  data: new SlashCommandBuilder()
    .setName("weekly-lost-experience")
    .setDescription("Calculate the weekly lost experience progress ranking")
    .setDescriptionLocalizations({
      "es-ES": "Calcular el ranking semanal de la experiencia perdida",
      "pt-BR": "Calcular o ranking semanal da experiência perdida",
      pl: "Oblicz ranking tygodniowy zdobytej doswiadczenia",
    })
