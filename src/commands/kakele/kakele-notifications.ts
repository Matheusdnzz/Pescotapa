...
export default new InteractionCommand({
  data: new SlashCommandBuilder()
    ...
    .setDescription(
      "Set up automatic notifications for Kakele boosts and events.",
    )
    .setDescriptionLocalizations({
      "es-ES":
        "Configura notificaciones automáticas para aumentos y eventos de Kakele.",
      "pt-BR":
        "Configure notificações automáticas para boosts e eventos do Kakele.",
      pl: "Skonfiguruj automatyczne powiadomienia o zwiększeniach i wydarzeniach w Kakele.",
    })
    .addSubcommand((subcommand) =>
      subcommand
        .setName("events")
        .setDescription("Set up automatic notifications for Kakele events.")
        .setDescriptionLocalizations({
          "es-ES":
            "Configura notificaciones automáticas para eventos de Kakele.",
    ...
    .addSubcommand((subcommand) =>
      subcommand
        .setName("boosts")
        .setDescription("Set up automatic notifications for Kakele boosts.")
        .setDescriptionLocalizations({
          "es-ES":
            "Configura notificaciones automáticas para aumentos de Kakele.",
      ...
      await interaction.editReply({
        embeds: [
          new CustomEmbed()
            .setTitle(
              client.translate(
                "KAKELE_NOTIFICATIONS_NO_PAYERS_TITLE",
                args.language,
              ),
            )
            .setDescription(
              client.translate(
                "KAKELE_NOTIFICATIONS_NO_PAYERS_DESCRIPTION",
                args.language,
              ),
            )
            .setAuthor({
      ...
      await interaction
        .editReply({
          ...
          embeds: [
            new CustomEmbed()
              .setTitle(
                client.translate(
                  "COMMAND_EVENT_ALERT_MAIN_ROW_TITLE",
                  args.language,
                ),
              )
              .setDescription(
                client.translate(
                  "COMMAND_EVENT_ALERT_MAIN_ROW_DESCRIPTION",
                  args.language,
                ),
              )
              .setAuthor({
        ...
        .then((message) => {
          ...
          function formatRoles(arr: string[]): string[] {
            return arr.map((x) =>
              x === "everyone" ? "@everyone" : `<@&${x}>`,
            );
          }

          async function showSettingsRow(
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_EVENT_ALERT_SETTINGS_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_EVENT_ALERT_SETTINGS_ROW_DESCRIPTION",
                      args.language,
                    ),
                  )
                  .setAuthor({
          ...
          async function showAddEventRow(
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_EVENT_ALERT_ADD_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    `${client.translate(
                      "COMMAND_EVENT_ALERT_ADD_ROW_DESCRIPTION",
                      args.language,
                    )}\n\`IDs:\` \`${convertToRangeString(
                      eventIDs,
                    )}\`\n\`Server:\` \`${server}\``,
                  )
                  .setAuthor({
              ...
              components: [
                new ActionRowBuilder<ButtonBuilder>()
                  ...
                  .addComponents(
                    ...
                    ).setDisabled(eventIDs.length === 0 || server.length <= 1),
                  ),
              ],
            });
          }

          async function showAddEventsChannelsRow(
            res: MessageComponentInteraction,
          ): Promise<void> {
            await res.deferUpdate();
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_EVENT_ALERT_ADD_CHANNEL_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_EVENT_ALERT_ADD_CHANNEL_ROW_DESCRIPTION",
                      args.language,
                    ),
                  )
                  .setAuthor({
          ...
          async function showSettingsChannelSelectionRow(
            res: MessageComponentInteraction,
          ): Promise<void> {
            await res.deferUpdate();
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_EVENT_ALERT_SETTINGS_CHANNEL_SELECTION_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_EVENT_ALERT_SETTINGS_CHANNEL_SELECTION_ROW_DESCRIPTION",
                      args.language,
                    ),
                  )
                  .setAuthor({
          ...
          async function clearChannel(
            res: ChannelSelectMenuInteraction,
          ): Promise<void> {
            await res.deferUpdate();
            ...
            res.channels.forEach((c) => {
              selectedChannels =
                args.guild?.config?.event_notification.filter(
                  (x) => x.channel !== c.id,
                ) ?? [];
            });
            ...
            await interaction
              ...
              .then((i) => {
                ...
                const messageCollector =
                  interaction.channel?.createMessageCollector({ time: 60000 });
                ...
                messageCollector?.on("collect", async (messageResponse) => {
                  ...
                  if (
                    messageResponse.cleanContent?.toLowerCase().includes("done")
                  ) {
          ...
          async function showAddEventsRoleSelection(
            res: ChannelSelectMenuInteraction,
          ): Promise<void> {
            await res.deferUpdate();
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_EVENT_ALERT_ADD_ROLE_SELECTION_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_EVENT_ALERT_ADD_ROLE_SELECTION_ROW_DESCRIPTION",
                      args.language,
                    ),
                  )
                  .setAuthor({
          ...
          async function showAddEventsServerSelection(
            res: MessageComponentInteraction,
          ): Promise<void> {
            await res.deferUpdate();
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_EVENT_ALERT_ADD_SERVER_SELECTION_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_EVENT_ALERT_ADD_SERVER_SELECTION_ROW_DESCRIPTION",
                      args.language,
                    ),
                  )
                  .setAuthor({
          ...
          async function showSettingsRoleSelection(
            res: MessageComponentInteraction,
          ): Promise<void> {
            await res.deferUpdate();
          ...
          async function showIndexSelectionRow(
            res?: MessageComponentInteraction,
          ): Promise<void> {
            await res?.deferUpdate();
            ...
            for (const eventConfig of args.guild.config.event_notification) {
              const index =
                args.guild.config.event_notification.indexOf(eventConfig);

              if (string.length <= 3700) {
                string += `\`📍${index}\` \`Channel: \` <#${
                  eventConfig.channel
                }> \`${eventConfig.server}\`\n┗\`Events: ${convertArrayToString(
                  eventConfig.events,
                )}\`\n┗━\`Roles: \`${formatRoles(eventConfig.roles).join(
                  " ",
                )}\n\n`;
              } else {
                string += `> +${
                  args.guild.config.event_notification.length - index
                }...`;
                break;
              }
            }
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_EVENT_ALERT_SETTINGS_INDEX_SELECTION_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_EVENT_ALERT_SETTINGS_INDEX_SELECTION_DESCRIPTION",
                      args.language,
                      { string },
                    ),
                  )
              ...
              components: [
                new ActionRowBuilder<ButtonBuilder>()
                  ...
                  .addComponents(
                    ...
                    ).setDisabled(string.length === 0),
                  ),
              ],
            });
          }

          async function showIndexSelectionModal(
            res: MessageComponentInteraction,
          ): Promise<void> {
            const filter = (r): boolean =>
              r.customId === "NOTIFICATION_MODAL_EVENT_INDEX_SELECTION";

            await res.showModal(
              NOTIFICATION_MODAL_EVENT_INDEX_SELECTION(client, args.language),
            );
            ...
            interaction
              ...
              .then(async (e) => {
                ...
                if (args.guild !== undefined) {
                  if (
                    args.guild.config.event_notification[index] !== undefined
                  ) {
                    ...
                    await Guild.findOneAndUpdate(
                      { id: interaction.guild.id },
                      {
                        "config.event_notification":
                          args.guild.config.event_notification,
                      },
                    );
                    ...
                    await res.followUp({
                      content: client.i18n.__({
                        phrase:
                          "COMMAND_EVENT_ALERT_SETTINGS_CLEAR_INDEX_MODAL_SUCESS",
                        locale: args.language,
                      }),
                      ephemeral: true,
                    });
                    ...
                    await res.followUp({
                      content: client.i18n.__({
                        phrase:
                          "COMMAND_EVENT_ALERT_SETTINGS_CLEAR_INDEX_MODAL_REJECT",
                        locale: args.language,
                      }),
                      ephemeral: true,
                    });
              ...
              .catch(async () => {
                await res.followUp({
                  content: client.i18n.__({
                    phrase:
                      "COMMAND_EVENT_ALERT_SETTINGS_CLEAR_INDEX_MODAL_TIMEOUT",
                    locale: args.language,
                  }),
                  ephemeral: true,
                });
          ...
          async function settingsClearRole(
            res: RoleSelectMenuInteraction,
          ): Promise<void> {
            await res.deferUpdate();
            ...
            if (res.roles !== undefined) {
              res.roles.forEach((r) => {
                selectedRoles = args.guild.config.event_notification.filter(
                  (x) => !x.roles?.includes(r.id),
                );
              });
            } else {
              selectedRoles = args.guild.config.event_notification.filter(
                (x) => !x.roles?.includes("everyone"),
              );
            }
            ...
            await Guild.findOneAndUpdate(
              { id: interaction.guild.id },
              { "config.event_notification": selectedRoles },
            );
          ...
          async function settingsClearGuild(
            res: MessageComponentInteraction,
          ): Promise<void> {
            await res.deferUpdate();
          ...
          async function saveEvents(
            ...
            channels.forEach((c) => {
              const index = args.guild.config.event_notification.findIndex(
                (x) =>
                  x.channel === c.id &&
                  x.server === server &&
                  x.roles === roles &&
            ...
            if (interactionResponse.user.id === interaction.user.id) {
              ...
              switch (interactionResponse.customId) {
                ...
                case "NOTIFICATION_MENU_EVENT_SETTINGS_CHANNEL_SELECTION":
                  await clearChannel(
                    interactionResponse as ChannelSelectMenuInteraction,
                  );
                  break;
                ...
                case "NOTIFICATION_MENU_EVENT_CHANNEL_SELECTION":
                  await showAddEventsRoleSelection(
                    interactionResponse as ChannelSelectMenuInteraction,
                  );
                  break;
                ...
                case "NOTIFICATION_BUTTON_EVENT_ROLE_SET_EVERYONE":
                  await saveEvents(
                    interactionResponse as RoleSelectMenuInteraction,
                  );
                  break;
    ...
    async function boostNotification(): Promise<void> {
      await interaction
        .editReply({
          ...
          embeds: [
            new CustomEmbed()
              .setTitle(
                client.translate(
                  "COMMAND_BOOST_ALERT_MAIN_ROW_TITLE",
                  args.language,
                ),
              )
              .setDescription(
                client.translate(
                  "COMMAND_BOOST_ALERT_MAIN_ROW_DESCRIPTION",
                  args.language,
                ),
              )
              .setAuthor({
        ...
        .then((message) => {
          ...
          async function saveBoosts(): Promise<void> {
            ...
            setTimeout((): void => {
              Guild.findOneAndUpdate(
                { id: interaction.guild.id },
                {
                  "config.boost_notification":
                    args.guild.config.boost_notification,
                },
              )
                .then(async () => {
                  await showMainMenu();
          ...
          async function showAddBoostRow(
            res?: MessageComponentInteraction,
          ): Promise<void> {
            server = "";
            boosts = [];
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_BOOST_ALERT_SERVER&BOOST_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_BOOST_ALERT_SERVER&BOOST_ROW_DESCRIPTION",
                      args.language,
                    ),
                  )
                  .setAuthor({
              ...
              components: [
                new ActionRowBuilder<StringSelectMenuBuilder>().addComponents(
                  NOTIFICATION_MENU_BOOST_SELECTION(args.language),
                ),
                new ActionRowBuilder<StringSelectMenuBuilder>().addComponents(
                  GENERIC_SERVER_SELECTION(),
                ),
          ...
          async function showAddRolesAndChannelSelection(
            res?: MessageComponentInteraction,
          ): Promise<void> {
            await res?.deferUpdate();
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_BOOST_ALERT_CHANNEL&ROLE_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_BOOST_ALERT_CHANNEL&ROLE_ROW_DESCRIPTION",
                      args.language,
                    ),
                  )
                  .setAuthor({
          ...
          async function showIndexSelectionRow(
            ...
            for (const boostData of args.guild.config.boost_notification) {
              const index =
                args.guild.config.boost_notification.indexOf(boostData);
              ...
              if (string.length <= 3700) {
                string += `\`📍${index}\` \`Channel: \` <#${
                  ...
                  .map((x) => ` \`${x}\``)
                  .join(" ")}\n\`Roles: \` ${formatRoles(boostData.roles).join(
                  " ",
                )}\n\n`;
              } else {
                string += `> +${
                  args.guild.config.boost_notification.length - index
                }...`;
                break;
              }
            }
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_BOOST_ALERT_INDEX_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_BOOST_ALERT_INDEX_ROW_DESCRIPTION",
                      args.language,
                      { string },
                    ),
                  )
            ...
            await interaction.editReply({
              ...
              embeds: [
                new CustomEmbed()
                  .setTitle(
                    client.translate(
                      "COMMAND_BOOST_ALERT_CONFIG_ROW_TITLE",
                      args.language,
                    ),
                  )
                  .setDescription(
                    client.translate(
                      "COMMAND_BOOST_ALERT_CONFIG_ROW_DESCRIPTION",
                      args.language,
                    ),
                  )
                  .setAuthor({
          ...
          async function handleBoostSelection(
            res: RoleSelectMenuInteraction,
          ): Promise<void> {
            await res.deferUpdate();
